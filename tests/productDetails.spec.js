...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    expect(productDetails('fistProduct', 'secondProduct')[0] !== productDetails('fistProduct', 'secondProduct')[1]).toEqual(true);
    // Teste se os dois productIds terminam com 123.
    expect(productDetails()[0].details.productId).toMatch(/123/);
    expect(productDetails()[1].details.productId).toMatch(/123/);
    // https://archive.jestjs.io/docs/pt-br/expect#tomatchregexp--string
  });
});
